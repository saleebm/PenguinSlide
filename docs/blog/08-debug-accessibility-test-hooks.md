...
This is not a backdoor. It's a *test seam* — a piece of code that exists specifically so tests can poke a specific internal state from outside the public API. Crucially:
